  ...
  try {
    ...
    const output_units: outputUnits = await strict_output(
      ...
      // each json have this type of thing
      {
        ...
        chapters:
          "an array of chapters, each chapters should have a youtube search query and a chapter_title key in the json object",
      }
    );

    console.log("creating title and units from chatGPT", output_units);
    ...
    console.log("getting image_search_term from chatGPT", imageSearchTerm);
    ...
    console.log(
      "getting image using image_search_term from unsplash",
      course_image
    );
    ...
    console.log("adding course in database", course);
    ...
    console.log("adding units and title in database");
