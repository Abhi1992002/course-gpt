  ...
  return (
    <div ref={ref} className="flex flex-col w-[100%] h-[100%]">
      ...
      <div className="h-[30px] w-[100%] border-y rounded-t-lg flex items-center justify-start">
        <span className="bg-red-500 w-[10px] h-[10px] rounded-full mr-[10px] ml-[10px]" />
        <span className="bg-yellow-500 w-[10px] h-[10px] rounded-full mr-[10px]" />
        <span className="bg-green-500 w-[10px] h-[10px] rounded-full mr-[10px]" />
      </div>
      ...
      >
          ...
          <div className="w-[90%] h-[90%] overflow-y-hidden hover:overflow-y-auto overflow-x-hidden">
            ...
            {datas.map((data, i) => (
              ...
              >
                <div
                  className={clsx(
                    "mt-[10px] transition-all ease-in-out duration-500"
                  )}
                >
        ...
        {/* middle */}
        <div className=" border flex-2 flex items-center justify-center overflow-y-hidden hover:overflow-y-auto overflow-x-hidden relative">
            ...
            <div className="border-t-[0.5px] absolute border-foreground pt-[10px] flex justify-between w-[95%] bottom-[30px]  ">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-foreground">Previous</p>
                </div>
              </div>
              ...
              <div className="flex items-center absolute right-0">
                <div>
                  <p className="text-[12px] text-foreground/70">Previous</p>
                  <p className="text-sm font-bold text-foreground">Next</p>
                </div>
